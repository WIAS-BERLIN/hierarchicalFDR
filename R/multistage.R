multistage <- function(pValues, 
                       alpha = 0.05) { 
  # For the special case of 2 families, larger numbers are possible 
  # but were computationally too exhausting for large families as studied here
  result <- list()
